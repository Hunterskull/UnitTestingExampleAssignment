...
namespace UnitTestingExample.Tests
{
    ...
    public partial class StringUtilitiesTests
    {
        ...
        public void TestForEmptySplitPlaces()
        {
            ...
            // Assert
            result.First().Should().BeEquivalentTo("test"); // the first item should be equivalent to "test"
        }
        ...
        public void TestOrderingWhenCountsAreEqual()
        {
            ...
            // Assert
            result.Should().ContainInOrder(expected); // result should contain all items of expected in order
        }
    }
}
